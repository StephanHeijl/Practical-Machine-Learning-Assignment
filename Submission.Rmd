...
![](./GoodVariation.svg) ![](./BadVariation.svg)
...
The results are summarized in table 1. You can click on the headers to
sort the results. All these tests were performed with 10-fold cross
validation.
...
shows the time/performance ratio. Click on any of the headers to sort
the table by that attribute.
...
Produced with the Pretty R syntax Highlighter[[2]](#cite-2)
